...
<div id="popup">
  <h1>우편번호검색</h1>
  <form method=post name=formm action="ShopController?command=find_zip_num">
  ...
  <table id="zipcode">
    ...
    <tr>
      <td style="color: black">${addressVO.zipNum}</td>
        <td>
          <a href="#" onclick="result('${addressVO.zipNum}'
			,'${addressVO.sido}', '${addressVO.gugun}','${addressVO.dong}')" style="color: black">
